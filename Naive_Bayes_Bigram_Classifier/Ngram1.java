...
public class Ngram1 {
    ...
    PrintWriter out1 = new PrintWriter("output_pos_uni1.txt");
	PrintWriter out2 = new PrintWriter("output_pos_bigram1.txt");
	PrintWriter out3 = new PrintWriter("output_neg_uni1.txt");
	PrintWriter out4 = new PrintWriter("output_neg_bigram1.txt");
	PrintWriter out5 = new PrintWriter("bigram_result1.txt");
	PrintWriter out6 = new PrintWriter("bigram_vocab_all_data1.txt");
    ...
    BufferedReader br = new BufferedReader(new FileReader("train1.txt"));
