...
public class Ngram9 {
   ...
   //	PrintWriter out4 = new PrintWriter("output_neg_bigram.txt");
	PrintWriter out5 = new PrintWriter("bigram_result9.txt");
    ...
    BufferedReader br = new BufferedReader(new FileReader("train9.txt"));
   ...
   BufferedReader br1 = new BufferedReader(new FileReader("test9.txt"));
