...
public class Ngram3 {
   ...
   //	PrintWriter out4 = new PrintWriter("output_neg_bigram.txt");
	PrintWriter out5 = new PrintWriter("bigram_result3.txt");
    ...
    BufferedReader br = new BufferedReader(new FileReader("train3.txt"));
   ...
   BufferedReader br1 = new BufferedReader(new FileReader("test3.txt"));
