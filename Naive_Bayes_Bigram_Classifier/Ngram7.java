...
public class Ngram7 {
   ...
   //	PrintWriter out4 = new PrintWriter("output_neg_bigram.txt");
	PrintWriter out5 = new PrintWriter("bigram_result7.txt");
    ...
    BufferedReader br = new BufferedReader(new FileReader("train7.txt"));
   ...
   BufferedReader br1 = new BufferedReader(new FileReader("test7.txt"));
