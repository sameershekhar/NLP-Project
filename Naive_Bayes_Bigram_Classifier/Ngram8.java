...
public class Ngram8 {
   ...
   //	PrintWriter out4 = new PrintWriter("output_neg_bigram.txt");
	PrintWriter out5 = new PrintWriter("bigram_result8.txt");
    ...
    BufferedReader br = new BufferedReader(new FileReader("train8.txt"));
   ...
   BufferedReader br1 = new BufferedReader(new FileReader("test8.txt"));
