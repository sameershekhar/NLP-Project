...
public class Ngram6 {
   ...
   //	PrintWriter out4 = new PrintWriter("output_neg_bigram.txt");
	PrintWriter out5 = new PrintWriter("bigram_result6.txt");
    ...
    BufferedReader br = new BufferedReader(new FileReader("train6.txt"));
   ...
   BufferedReader br1 = new BufferedReader(new FileReader("test6.txt"));
