...
public class Ngram4 {
   ...
   //	PrintWriter out4 = new PrintWriter("output_neg_bigram.txt");
	PrintWriter out5 = new PrintWriter("bigram_result4.txt");
    ...
    BufferedReader br = new BufferedReader(new FileReader("train4.txt"));
   ...
   BufferedReader br1 = new BufferedReader(new FileReader("test4.txt"));
